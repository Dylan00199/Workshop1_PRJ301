...
<%
    ...
    String prodBrief    = request.getAttribute("prodBrief")    != null ? (String)request.getAttribute("prodBrief")         : "";
    String prodPrice    = request.getAttribute("prodPrice")    != null ? String.valueOf(request.getAttribute("prodPrice"))  : "";
    String prodDiscount = request.getAttribute("prodDiscount") != null ? String.valueOf(request.getAttribute("prodDiscount")) : "0";
    String prodPostDate = request.getAttribute("prodPostDate") != null ? (String)request.getAttribute("prodPostDate")      : "";
    String prodImageUrl = request.getAttribute("prodImageUrl") != null ? (String)request.getAttribute("prodImageUrl")      : "";
    boolean prodActive  = !"false".equals(String.valueOf(request.getAttribute("prodActive")));
...
<head>
    ...
    <style>
        ...
        .form-section-title.mt { margin-top: 10px; }
        ...
        .form-group input[type="file"] { padding: 5px 12px; cursor: pointer; }
        ...
        .img-inputs { flex: 1; display: flex; flex-direction: column; gap: 10px; }
        .img-inputs label {
            font-size: 13px;
            font-weight: 600;
            color: #444;
        ...
        .img-inputs input:focus { border-color: #2980b9; }
        ...
        .btn-save:hover { background: #1f6fa0; }
        .btn-cancel {
            padding: 8px 18px;
            background: #fff;
            color: #555;
        ...
        .btn-delete-prod:hover { background: #fdf2f2; }
    </style>
</head>
<body>
...
<div class="page-content">
    ...
    <div class="breadcrumb">
        <a href="MainController?action=listProduct">Products</a>
    ...
    <form action="MainController" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-layout">
            ...
            <div class="form-group">
                ...
                <span class="id-badge">#<%= prodId.isEmpty() ? "—" : prodId %></span>
            </div>

            <%-- Post date --%>
            <div class="form-group">
                <label>Post date <span class="required">*</span></label>
                <input type="date" name="postDate" value="<%= prodPostDate %>">
            </div>
            ...
            <div class="form-group">
                ...
                <select name="categoryId">
                    ...
                    <option value="<%= c.getId() %>" <%= String.valueOf(c.getId()).equals(prodCatId) ? "selected" : "" %>>
                        <%= c.getName() %>
                    </option>
                    <% } --%>
                    <option value="1" <%= "1".equals(prodCatId) ? "selected" : "" %>>Electronics</option>
                    <option value="2" <%= "2".equals(prodCatId) ? "selected" : "" %>>Outdoor &amp; Travel</option>
                    <option value="3" <%= "3".equals(prodCatId) ? "selected" : "" %>>Clothing</option>
                    <option value="4" <%= "4".equals(prodCatId) ? "selected" : "" %>>Sports &amp; Fitness</option>
                </select>
            </div>
            ...
            <div class="form-group full">
                ...
                <textarea name="brief"
                          placeholder="Short description shown on product card..."><%= prodBrief %></textarea>
            </div>
            ...
            <%-- ===== STATUS ===== --%>
            <div class="form-section-title mt">Status</div>
            ...
            <div class="form-actions">
                ...
                <a href="MainController?action=deleteProduct&id=<%= prodId %>"
...
function previewUrl(url) {
    if (url && url.trim()) showPreview(url.trim());
    else hidePreview();
}
