...
<%
    ...
    Category cat = CategoryDAO.getInstance().getObjectById(Id);
    ...
    <body>
        ...
        <div class="page-content">
            ...
            <div class="breadcrumb">
                <a href="MainController?action=listCategory">Categories</a>
            ...
            <form action="CategoryController" method="POST" class="cat-form">
                ...
                <textarea name="memo"
                          placeholder="Short description of this category..."><%=cat.getMemo()%></textarea>

                <%-- Actions --%>
                <span class="spacer"></span>
                <div class="form-actions">
                    <button type="submit" class="btn-save">Save changes</button>
                    <a href="CategoryController?action=updateCategory" class="btn-cancel">Cancel</a>
                </div>
            </form>
        </div>
