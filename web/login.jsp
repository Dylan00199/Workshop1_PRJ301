...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .top-bar-brand { font-size: 14px; color: #555; }
        .top-bar-brand strong { color: #c0392b; }
        ...
        .error-box::before { content: "✕"; font-weight: bold; }
        ...
        .btn-login:hover { background: #1f6fa0; }
        .btn-login:active { background: #1a5d88; }
