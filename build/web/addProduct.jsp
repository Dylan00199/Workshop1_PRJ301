        ...
        <div class="form-layout">
            ...
            <div class="form-group">
                ...
                <input type="date" name="postDate"
                       value="<%= request.getParameter("postDate") != null ? request.getParameter("postDate") : "" %>">
            </div>

            <%-- Brief --%>
            <div class="form-group full-width">
                <label>Brief description</label>
                <textarea name="brief" placeholder="Short description shown on product card..."><%= request.getParameter("brief") != null ? request.getParameter("brief") : "" %></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-prefix-wrap">
                    ...
                    <input type="number" name="discount" min="0" max="100" step="1"
                           placeholder="0"
                           value="<%= request.getParameter("discount") != null ? request.getParameter("discount") : "0" %>">
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="imageUrl"
                       ...
                       value="<%= request.getParameter("imageUrl") != null ? request.getParameter("imageUrl") : "" %>"
            ...
            <div class="form-group full-width">
                <label class="checkbox-label">
                    <input type="checkbox" name="active" value="true"
                           <%= "true".equals(request.getParameter("active")) ? "checked" : "" %>>
